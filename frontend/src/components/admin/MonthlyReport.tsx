...
const MonthlyReport = () => {
  ...
  const downloadPDF = () => {
    ...
    // Month
    doc.setFontSize(12);
    doc.text(`Month: ${reportData.month}`, 20, yPosition);
    yPosition += 15;
    ...
    doc.save(`monthly-report-${reportData.month}.pdf`);
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h2 className="text-2xl font-bold">Monthly Report - {reportData.month}</h2>
