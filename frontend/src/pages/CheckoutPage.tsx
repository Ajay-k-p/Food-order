...
const CheckoutPage = () => {
  ...
  // Handle navigation after order confirmation
  useEffect(() => {
    if (shouldNavigate) {
      clearCart();
  ...
  }, [shouldNavigate, clearCart, navigate]);
  ...
  const handleAddressSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (!address.fullAddress || !address.phoneNumber) {
  ...
  const handlePaymentConfirm = async () => {
    ...
    try {
      ...
      // Clear cart and show success after delay
      setTimeout(() => {
